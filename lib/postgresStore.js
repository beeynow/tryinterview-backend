...
async function upsertUser(userData) {
  const rows = await query(`
    ...
    ON CONFLICT (firebase_uid) DO UPDATE SET
      ...
      email_verified = COALESCE(EXCLUDED.email_verified, app_users.email_verified),
      onboarded = COALESCE(EXCLUDED.onboarded, app_users.onboarded),
      job_title = COALESCE(EXCLUDED.job_title, app_users.job_title),
      experience = COALESCE(EXCLUDED.experience, app_users.experience),
      skills = COALESCE(EXCLUDED.skills, app_users.skills),
      goals = COALESCE(EXCLUDED.goals, app_users.goals),
      interview_type = COALESCE(EXCLUDED.interview_type, app_users.interview_type),
      availability = COALESCE(EXCLUDED.availability, app_users.availability),
      notifications = COALESCE(EXCLUDED.notifications, app_users.notifications),
      customer_id = COALESCE(EXCLUDED.customer_id, app_users.customer_id),
  ...
  `, [
    ...
    toJsonb(userData.skills, null),
    userData.goals ?? null,
    userData.interviewType ?? null,
    toJsonb(userData.availability, null),
    toJsonb(userData.notifications, null),
    userData.customerId ?? null,
    toJsonb(userData.metadata, null),
