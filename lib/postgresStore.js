...
async function upsertUser(userData) {
  ...
  const mergedUserData = {
    ...
    gender: hasOwn(userData, 'gender') ? (userData.gender ?? null) : (existingUser?.gender ?? null),
    phoneNumber: hasOwn(userData, 'phoneNumber') ? (userData.phoneNumber ?? null) : (existingUser?.phoneNumber ?? null),
  ...
  `, [
    ...
    mergedUserData.gender,
    mergedUserData.phoneNumber,
