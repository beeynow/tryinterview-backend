...
function buildInterviewPrompt(context) {
  ...
  return [
    'Create a professional mock interview plan for TryInterview AI using InterviewGPT Elite standards.',
...
function buildEvaluationPrompt({ session, question, answer }) {
  return [
    'Evaluate this interview answer for TryInterview AI using InterviewGPT Elite standards.',
...
function buildFinalSummaryPrompt({ session, questionRows, aggregate }) {
  ...
  return [
    'Create the final interview report for TryInterview AI using InterviewGPT Elite standards.',
